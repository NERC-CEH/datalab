...
* **[GitHub Actions](https://github.com/NERC-CEH/datalab/actions)** - GitHub Actions is used as our continuous integration server and is free for open source use. Build is configured via `.github/workflows` files in the root of the Datalab repository.
