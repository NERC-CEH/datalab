...
>>> | 8 | Click create notebook button. Fill in form with with details for new project including multiple assets. Click create button. | Notebook is created. | PASS |
---
...
>>> | 6 | Using the asset multiselect it should be possible to add and remove assets from the notebook. | The list of assets associated with the notebook has changed to be those selected. | PASS |
>>> | 6 | Click apply. | The notebook should update successfully. | PASS |
---
...
>>> | 7 | Click on the cross in one of the asset chips in the assets box. | The asset for which the cross was clicked is no longer visible in the assets box nor in the list of assets. | PASS |
