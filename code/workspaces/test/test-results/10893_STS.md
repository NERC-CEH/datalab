...
>>> | 5 | Click on the notebook's three dot button and then on the edit option. | A dialog is shown with fields that can be edited. One of them is assets. The assets field is pre-populated with any assets the notebooks is using. | PASS |
