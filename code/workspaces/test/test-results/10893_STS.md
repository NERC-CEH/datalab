...
>>> | 7 | Select some filters e.g. instance admin and project admin | The page is filtered to only show users that meet one of these filter requirements. Checkboxes are clearly marked as selected | PASS |
