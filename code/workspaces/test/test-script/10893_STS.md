...
| 5 | In the warning message 'Package shiny required but is not installed', select Install | the Jobs tab (bottom left) to show '✔ Package 'shiny' successfully installed' | PASS |
...
| 3 | Create a new notebook | Notebook is created | PASS |
| 4 | Open the new notebook and paste the copied snippet into the cell | Notebook is opened and snippet is pasted | PASS |
...
#### TC2.6.2.4 User can sign in  to datalabs deployed to Kubernetes
