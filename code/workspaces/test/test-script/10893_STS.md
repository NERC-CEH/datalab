...
>>> | 8 | Click create notebook button. Fill in form with with details for new notebook including multiple assets (one of which should actually exist on the repo file store). Click create button. | Notebook is created. |  |
