...
| **JIRA ID(s):** | [NERCDL-964](https://jira.ceh.ac.uk/browse/NERCDL-964) |OVERALL RESULT: | FAIL |
| ------------ | --------- | --------- | ------|
| **Number** | **Step** | **Expected Result** | **Result** |
...
#### TC[2.2.4.1.1.2] Dask clusters are listed in the UI

| **JIRA ID(s):** | [NERCDL-962](https://jira.ceh.ac.uk/browse/NERCDL-962) |OVERALL RESULT: | PASS |
| ------------ | --------- | --------- | ------|
| **Number** | **Step** | **Expected Result** | **Result** |
...
###### TC[2.2.4.1.3] Create Condo Dask cluster
