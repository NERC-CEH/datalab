...
>>> | **JIRA ID(s):** | [NERCDL-919](https://jira.ceh.ac.uk/browse/NERCDL-919), [NERCDL-934](https://jira.ceh.ac.uk/browse/NERCDL-934) |OVERALL RESULT: | |
>>> | ------------ | --------- | --------- | ------|
>>> | **Number** | **Step** | **Expected Result** | **Result** |
...
>>> | 8 | Click create notebook button. Fill in form with with details for new project including multiple assets. Click create button. | Notebook is created. |  |
---
...
>>> | 6 | Using the asset multiselect it should be possible to add and remove assets from the notebook. | The list of assets associated with the notebook has changed to be those selected. |  |
>>> | 6 | Click apply. | The notebook should update successfully. |  |
---
