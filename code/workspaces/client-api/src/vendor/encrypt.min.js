 ...
 * https://github.com/rstudio/rstudio/blob/master/src/gwt/www/js/encrypt.min.js
 * Unfortunately, no unminified version was available.
 *
 * The file has been adjusted to allow it to be executed in a server environment as part of a seamless login flow
 * The main changes were the addition of the navigator block (as this is usually provided by the browser) and
 * the export of the encrypt function to allow it to be used in a separate module
 */
const navigator =  {
  appName: 'Netscape',
  appVerson: '5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.100 Safari/537.36',
};
