...
const resolvers = {
  ...
  Mutation: {
    ...
    scaleupStack: (obj, { stack }, { user, token }) => w(stackApi.scaleUpStack({ user, token }, stack)),
    scaledownStack: (obj, { stack }, { user, token }) => w(stackApi.scaleDownStack({ user, token }, stack)),
