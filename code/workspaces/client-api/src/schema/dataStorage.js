...
export const dataStorage = {
  ...
  resolve: (obj, args, { user }) => permissionChecker(STORAGE_LIST, user, () => dataStorageRepository.getAllActive(user)),
};
...
export const dataStore = {
  ...
  resolve: (obj, { id }, { user }) => permissionChecker(STORAGE_OPEN, user, () => dataStorageRepository.getById(user, id)),
};
