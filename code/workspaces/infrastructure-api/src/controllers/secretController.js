...
export async function getStackSecret(request, response) {
  ...
  const secret = await readSecret(response, secretName, projectKey);
...
export async function readSecret(response, secretName, projectKey) {
...
export function decodeSecretData(data) {
...
export const getStackSecretValidator = () => [
