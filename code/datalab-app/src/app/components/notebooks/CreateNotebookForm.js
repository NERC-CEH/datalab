...
import { getStackSelections } from '../../../shared/stackTypes';
...
const CreateNotebookForm = (props) => {
  ...
  return (
    <Form onSubmit={ handleSubmit }>
      ...
      <Field name='type' label='Notebook Type' component={renderDropdownField} options={getStackSelections()} placeholder='Notebook Type'/>
